...
(() => {
  window.LoadToAgentMessages = Object.freeze({
    ...
    "runtime.schedule_lane": {"ko":"Schedule lane","en":"Schedule lane","zh-CN":"计划通道"},
    ...
    "runtime.loop_lane": {"ko":"Loop inspector","en":"Loop inspector","zh-CN":"循环检查器"},
    "runtime.loop_system": {"ko":"실행 루프 구조","en":"Execution loop","zh-CN":"执行循环结构"},
    ...
    "quality.copy_workspace": {"ko":"전체 작업 폴더 경로 복사","en":"Copy full workspace path","zh-CN":"复制完整工作文件夹路径"},
    ...
    "quality.workspace_added": {"ko":"작업 폴더를 추가했습니다. 현재 {count}개입니다.","en":"Workspace added. {count} are now registered.","zh-CN":"已添加工作文件夹。当前共 {count} 个。"},
    "quality.workspace_filter": {"ko":"작업 폴더 필터","en":"Workspace filter","zh-CN":"工作文件夹筛选器"},
    "quality.workspace_removed": {"ko":"{name} 작업 폴더를 제거했습니다.","en":"Removed the {name} workspace.","zh-CN":"已移除 {name} 工作文件夹。"},
    ...
    "workspace.unknown": {"ko":"작업 폴더 미상","en":"Unknown workspace","zh-CN":"未知工作文件夹"},
    "workspace.remove_named": {"ko":"{name} 작업 폴더를 목록에서 제거","en":"Remove the {name} workspace from the list","zh-CN":"从列表中移除 {name} 工作文件夹"},
    ...
    "graph.major_tasks_and_agents": {"ko":"큰 일 {tasks}개 · 참여 AI {agents}명","en":"{tasks} major tasks · {agents} participating AI","zh-CN":"{tasks} 个主要任务 · {agents} 个参与 AI"},
    ...
    "graph.runtime_count_explanation": {"ko":"실행 중인 AI 세션 {sessions}개입니다. 작업 중 도움 AI {helpers}개가 포함됩니다.","en":"{sessions} AI sessions are running, including {helpers} active helper AI.","zh-CN":"当前有 {sessions} 个 AI 会话运行中，其中包含 {helpers} 个协助 AI。"},
