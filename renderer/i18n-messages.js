...
(() => {
  window.LoadToAgentMessages = Object.freeze({
    ...
    "observed.agent_loop_running": {"ko":"에이전트 루프 실행 중","en":"Agent loop running","zh-CN":"智能体循环运行中"},
    ...
    "observed.subagent_started": {"ko":"서브에이전트 실행 시작","en":"Subagent started","zh-CN":"子智能体已启动"},
    "observed.subagent_status_changed": {"ko":"서브에이전트 상태 변경","en":"Subagent status changed","zh-CN":"子智能体状态已更改"},
    ...
    "observed.agent_message": {"ko":"에이전트 메시지","en":"Agent message","zh-CN":"智能体消息"},
    ...
    "observed.subagent_work": {"ko":"서브에이전트 작업","en":"Subagent work","zh-CN":"子智能体工作"},
    "observed.completion_record": {"ko":"작업 완료 기록","en":"Completion record","zh-CN":"任务完成记录"},
    "observed.start_observed": {"ko":"실행 시작 관측","en":"Start observed","zh-CN":"已观测到启动"},
    ...
    "runtime.section_label": {"ko":"예약 작업과 실행 루프","en":"Scheduled work and running loops","zh-CN":"计划任务与运行循环"},
    "runtime.eyebrow": {"ko":"자동 실행 관제","en":"Automation control","zh-CN":"自动运行监控"},
    "runtime.title": {"ko":"스케줄 · 루프 시스템","en":"Schedules · Loop system","zh-CN":"计划 · 循环系统"},
    "runtime.description": {"ko":"다음 예약과 지금 반복 중인 에이전트 흐름을 함께 봅니다.","en":"See upcoming schedules and active agent loops together.","zh-CN":"同时查看即将执行的计划和正在运行的智能体循环。"},
    "runtime.status_summary": {"ko":"예약 및 실행 상태","en":"Schedule and run status","zh-CN":"计划与运行状态"},
    ...
    "runtime.loops_count": {"ko":"실행 루프 {count}","en":"{count} running loops","zh-CN":"{count} 个运行循环"},
    "runtime.schedule_lane": {"ko":"예약 관제","en":"Schedule control","zh-CN":"计划监控"},
    "runtime.next_schedules": {"ko":"다음 예약","en":"Up next","zh-CN":"后续计划"},
    "runtime.schedule_list": {"ko":"전체 예약","en":"All schedules","zh-CN":"全部计划"},
    "runtime.schedule_list_label": {"ko":"활성 및 일시정지 예약 목록. 방향키와 Page Up, Page Down 키로 스크롤할 수 있습니다.","en":"Active and paused schedules. Use arrow, Page Up, or Page Down keys to scroll.","zh-CN":"启用和暂停的计划列表。可使用方向键、Page Up 或 Page Down 滚动。"},
    "runtime.paused": {"ko":"일시정지","en":"Paused","zh-CN":"已暂停"},
    "runtime.workspace_unspecified": {"ko":"작업공간 미지정","en":"No workspace","zh-CN":"未指定工作区"},
    "runtime.loop_lane": {"ko":"루프 추적","en":"Loop tracking","zh-CN":"循环追踪"},
    "runtime.loop_system": {"ko":"반복 실행 흐름","en":"Execution loop","zh-CN":"执行循环结构"},
    "runtime.inferred_phase": {"ko":"최근 세션 이벤트를 바탕으로 현재 위치를 추정합니다.","en":"Current position is inferred from recent session events.","zh-CN":"当前位置根据最近的会话事件推测。"},
    "runtime.choose_loop": {"ko":"확인할 실행 루프 선택","en":"Choose a running loop","zh-CN":"选择要查看的运行循环"},
    ...
    "runtime.active_loop": {"ko":"지금 루프 실행 중","en":"Loop running now","zh-CN":"循环正在运行"},
    "runtime.open_task": {"ko":"작업 열기","en":"Open task","zh-CN":"打开任务"},
    "runtime.loop_flow_label": {"ko":"입력, 판단, 실행, 관측을 반복하는 에이전트 실행 흐름","en":"Agent loop from input through decision, action, and observation","zh-CN":"从输入、判断、执行到观测的智能体循环"},
    "runtime.loop_flow_state": {"ko":"입력, 판단, 실행, 관측을 반복하는 에이전트 실행 흐름. 최근 이벤트로 추정한 현재 위치는 {phase} 단계입니다.","en":"Agent loop through input, decision, action, and observation. The current inferred phase is {phase}.","zh-CN":"智能体依次循环输入、判断、执行与观测。根据最近事件推测，当前处于{phase}阶段。"},
    "runtime.phase_input": {"ko":"입력","en":"Input","zh-CN":"输入"},
    "runtime.phase_input_detail": {"ko":"목표 · 맥락","en":"Goal · context","zh-CN":"目标 · 上下文"},
    "runtime.phase_decide": {"ko":"판단","en":"Decide","zh-CN":"判断"},
    "runtime.phase_decide_detail": {"ko":"계획 · 추론","en":"Plan · reason","zh-CN":"计划 · 推理"},
    "runtime.phase_act": {"ko":"실행","en":"Act","zh-CN":"执行"},
    "runtime.phase_act_detail": {"ko":"도구 · 위임","en":"Tools · delegate","zh-CN":"工具 · 委派"},
    "runtime.phase_observe": {"ko":"관측","en":"Observe","zh-CN":"观测"},
    "runtime.phase_observe_detail": {"ko":"결과 · 검수","en":"Result · review","zh-CN":"结果 · 检查"},
    "runtime.phase_repeat": {"ko":"다음 판단으로","en":"Continue loop","zh-CN":"进入下一轮判断"},
    ...
    "runtime.current_phase": {"ko":"현재 단계","en":"Current phase","zh-CN":"当前阶段"},
    "runtime.now_working": {"ko":"지금 하는 일","en":"Working on now","zh-CN":"当前工作"},
    "runtime.last_signal_time": {"ko":"최근 신호 · {time}","en":"Latest signal · {time}","zh-CN":"最新信号 · {time}"},
    "runtime.latest_signal": {"ko":"최근 신호","en":"Latest signal","zh-CN":"最新信号"},
    "runtime.running_time": {"ko":"실행 시간","en":"Runtime","zh-CN":"运行时间"},
    "runtime.iteration": {"ko":"반복 상태","en":"Loop state","zh-CN":"循环状态"},
    "runtime.iteration_value": {"ko":"{count}회차","en":"#{count}","zh-CN":"第 {count} 轮"},
    "runtime.iteration_observed": {"ko":"계속 관측 중","en":"Observing","zh-CN":"持续观测中"},
    "runtime.iteration_scheduled": {"ko":"예약 실행","en":"Scheduled run","zh-CN":"计划运行"},
    "runtime.subagents": {"ko":"서브에이전트","en":"Subagents","zh-CN":"子智能体"},
    ...
    "runtime.no_active_loop": {"ko":"현재 실행 중인 루프 없음","en":"No loop is running","zh-CN":"当前没有运行中的循环"},
    "runtime.no_active_loop_detail": {"ko":"예약이 시작되거나 AI 작업이 실행되면 단계별 흐름이 여기에 나타납니다.","en":"A step-by-step flow appears here when a schedule or AI task starts.","zh-CN":"计划或 AI 任务启动后，分步流程会显示在这里。"},
    ...
    "quality.copy_workspace": {"ko":"시작 프로젝트 전체 경로 복사","en":"Copy full origin project path","zh-CN":"复制完整的起始项目路径"},
    ...
    "quality.workspace_added": {"ko":"프로젝트를 추가했습니다. 현재 {count}개를 고정했습니다.","en":"Project added. {count} are now pinned.","zh-CN":"已添加项目。当前已固定 {count} 个。"},
    "quality.workspace_filter": {"ko":"프로젝트별 세션 필터","en":"Session filter by project","zh-CN":"按项目筛选会话"},
    "quality.workspace_removed": {"ko":"{name} 프로젝트 고정을 해제했습니다.","en":"Unpinned the {name} project.","zh-CN":"已取消固定 {name} 项目。"},
    ...
    "workspace.unknown": {"ko":"프로젝트 미상","en":"Unknown project","zh-CN":"未知项目"},
    "workspace.remove_named": {"ko":"{name} 프로젝트 고정 해제","en":"Unpin the {name} project","zh-CN":"取消固定 {name} 项目"},
    "project.all": {"ko":"모든 프로젝트","en":"All projects","zh-CN":"所有项目"},
    "project.empty": {"ko":"세션이 관측되면 시작 프로젝트별로 자동 분류됩니다.","en":"Observed sessions are grouped automatically by their origin project.","zh-CN":"观测到的会话会按起始项目自动分组。"},
    "project.filter_named": {"ko":"{name} 프로젝트의 세션 {count}개 보기","en":"Show {count} sessions from the {name} project","zh-CN":"查看 {name} 项目的 {count} 个会话"},
    "project.origin": {"ko":"시작 프로젝트","en":"Origin project","zh-CN":"起始项目"},
    "project.origin_named": {"ko":"시작 프로젝트 · {name}","en":"Origin project · {name}","zh-CN":"起始项目 · {name}"},
    ...
    "agent.direct_status": {"ko":"직접 입력 가능 · {target}","en":"Direct input available · {target}","zh-CN":"可直接输入 · {target}"},
    "agent.choose_terminal_count": {"ko":"{count}개 터미널 중 선택","en":"choose from {count} terminals","zh-CN":"从 {count} 个终端中选择"},
    "agent.handoff_status": {"ko":"외부 터미널에서 실행 중 · 같은 대화로 이어받기 가능","en":"Running in an external terminal · conversation can be handed off","zh-CN":"正在外部终端运行 · 可接管同一对话"},
    "agent.resume_status": {"ko":"원래 터미널이 종료됨 · 같은 세션으로 복구 가능","en":"Original terminal ended · session can be restored","zh-CN":"原终端已结束 · 可恢复同一会话"},
    "agent.origin_resume_status": {"ko":"쉬는 데스크톱 작업 · 백그라운드 터미널로 이어가기 가능","en":"Idle desktop task · can continue in a background terminal","zh-CN":"桌面任务已空闲 · 可在后台终端继续"},
    "agent.connect_status": {"ko":"연결 후 입력 가능 · 현재 세션은 보기 전용","en":"Input available after connecting · current session is read-only","zh-CN":"连接后可输入 · 当前会话为只读"},
    "agent.origin_status": {"ko":"보기 전용 · 원래 앱에서 계속","en":"Read-only · continue in the original app","zh-CN":"只读 · 在原应用中继续"},
    ...
    "agent.origin_resume_help": {"ko":"원래 {provider} 앱으로 돌아가거나, 같은 세션을 백그라운드 터미널로 이어서 작업할 수 있습니다.","en":"Return to the original {provider} app or continue the same session in a background terminal.","zh-CN":"可返回原 {provider} 应用，或在后台终端中继续同一会话。"},
    ...
    "agent.restore_and_send": {"ko":"같은 세션으로 복구해 보내기 ↵","en":"Restore the session and send ↵","zh-CN":"恢复同一会话并发送 ↵"},
    "agent.handing_off": {"ko":"이어받는 중…","en":"Handing off…","zh-CN":"正在接管…"},
    "agent.handoff_and_send": {"ko":"관리 터미널로 이어받아 보내기 ↵","en":"Hand off to a managed terminal and send ↵","zh-CN":"接管到管理终端并发送 ↵"},
    "agent.connecting": {"ko":"연결하는 중…","en":"Connecting…","zh-CN":"正在连接…"},
    "agent.background_and_send": {"ko":"백그라운드 터미널로 이어서 보내기 ↵","en":"Continue in a background terminal and send ↵","zh-CN":"在后台终端继续并发送 ↵"},
    "agent.copy_bridge": {"ko":"연결 명령 복사","en":"Copy connection command","zh-CN":"复制连接命令"},
    ...
    "drawer.subagent_title": {"ko":"{name} · 서브에이전트 작업 기록","en":"{name} · Subagent work history","zh-CN":"{name} · 子智能体工作记录"},
    ...
    "drawer.main_to_child": {"ko":"메인 AI → 서브에이전트","en":"Main AI → Subagent","zh-CN":"主 AI → 子智能体"},
    ...
    "drawer.subagent_history_actual": {"ko":"이 서브에이전트 세션에 실제로 저장된 작업 지시와 답변을 시간순으로 표시합니다.","en":"Shows the instructions and responses actually saved in this subagent session, in chronological order.","zh-CN":"按时间顺序显示此子智能体会话中实际保存的指令和回答。"},
    "drawer.subagent_work_history": {"ko":"서브에이전트 실제 작업 기록","en":"Actual subagent work history","zh-CN":"子智能体实际工作记录"},
    "drawer.assignment": {"ko":"작업 지시","en":"Assignment","zh-CN":"任务指令"},
    "drawer.sub_ai": {"ko":"서브 AI","en":"Sub AI","zh-CN":"子 AI"},
    ...
    "session.subagents_created": {"ko":"서브에이전트 {count}개 누적 생성","en":"{count} subagents created","zh-CN":"累计创建 {count} 个子智能体"},
    ...
    "app.nav.runtime": {"ko":"스케줄·루프","en":"Schedules & loops","zh-CN":"计划与循环"},
    ...
    "graph.assigned_to_subagent": {"ko":"{task}을 서브에이전트에게 배정했습니다.","en":"Assigned {task} to a subagent.","zh-CN":"已将{task}分配给子智能体。"},
    ...
    "graph.capacity_source_unknown": {"ko":"동시 한도 출처 미확인","en":"Concurrent limit source unknown","zh-CN":"并发上限来源未知"},
    "graph.central_ai": {"ko":"이 작업의 중심 AI","en":"Central AI for this task","zh-CN":"此任务的核心 AI"},
    "graph.central_task": {"ko":"중심 작업","en":"Main task","zh-CN":"核心任务"},
    ...
    "graph.communication_title": {"ko":"메인 AI ↔ 서브에이전트 소통","en":"Main AI ↔ subagent communication","zh-CN":"主 AI ↔ 子智能体通信"},
    ...
    "graph.completed_subagents": {"ko":"완료된 서브에이전트 {count}개","en":"{count} completed subagents","zh-CN":"{count} 个已完成的子智能体"},
    ...
    "graph.execution_activity": {"ko":"셸·백그라운드 실행","en":"Shell and background execution","zh-CN":"Shell 与后台执行"},
    "graph.execution_activity_description": {"ko":"이 AI가 시작한 명령과 백그라운드 작업을 호출 ID로 추적","en":"Commands and background work started by this AI, tracked by call ID","zh-CN":"按调用 ID 跟踪此 AI 启动的命令和后台工作"},
    ...
    "graph.execution_unit_summary": {"ko":"서브에이전트 {subagents} · 셸/백그라운드 {executions}","en":"{subagents} subagents · {executions} shell/background runs","zh-CN":"{subagents} 个子智能体 · {executions} 个 Shell/后台执行"},
    ...
    "graph.no_active_subagents": {"ko":"현재 작업 중인 서브에이전트가 없습니다","en":"No subagents are currently working","zh-CN":"当前没有正在工作的子智能体"},
    "graph.no_communication_events": {"ko":"이 세션 로그에서는 에이전트 간 통신 이벤트가 확인되지 않았습니다.","en":"No inter-agent communication events were found in this session log.","zh-CN":"此会话日志中未发现智能体间通信事件。"},
    ...
    "graph.open_tmux_workspace": {"ko":"tmux 작업 보기","en":"View tmux workspaces","zh-CN":"查看 tmux 工作"},
    "graph.open_tmux_workspace_count": {"ko":"tmux 작업 보기 · 세션 {count}개","en":"View tmux workspaces · {count} sessions","zh-CN":"查看 tmux 工作 · {count} 个会话"},
    "graph.open_tmux_pane": {"ko":"{session} TMUX 칸 열기","en":"Open TMUX pane in {session}","zh-CN":"打开 {session} 的 TMUX 窗格"},
    "graph.observed_execution_units": {"ko":"탐지된 실행 단위","en":"Observed execution units","zh-CN":"已检测的执行单元"},
    ...
    "graph.retained_count": {"ko":"현재 런타임 목록에는 {count}개 유지","en":"{count} retained in the current runtime list","zh-CN":"当前运行时列表保留 {count} 个"},
    "graph.retained_count_unobserved": {"ko":"현재 목록 유지 수는 관측되지 않음","en":"Current retained count was not observed","zh-CN":"未观测到当前保留数量"},
    ...
    "graph.runtime_execution_count": {"ko":"실행 중 셸 {shell}개 · 백그라운드 {background}개","en":"{shell} shell · {background} background running","zh-CN":"运行中 Shell {shell} 个 · 后台 {background} 个"},
    "graph.runtime_unknown": {"ko":"실행 환경 미상","en":"Runtime unavailable","zh-CN":"运行环境未知"},
    "graph.running_background": {"ko":"실행 중 백그라운드","en":"Background running","zh-CN":"运行中的后台任务"},
    "graph.running_shell": {"ko":"실행 중 셸","en":"Shell running","zh-CN":"运行中的 Shell"},
    ...
    "graph.session_runtime_limit": {"ko":"세션 런타임 한도","en":"Session runtime limit","zh-CN":"会话运行时上限"},
    ...
    "graph.simultaneous_capacity": {"ko":"동시에 유지 가능","en":"Concurrent capacity","zh-CN":"可同时保持"},
    ...
    "graph.shell_background": {"ko":"백그라운드 셸","en":"Background shell","zh-CN":"后台 Shell"},
    "graph.shell_foreground": {"ko":"포그라운드 셸","en":"Foreground shell","zh-CN":"前台 Shell"},
    ...
    "graph.sub_ai": {"ko":"서브 AI","en":"Sub-AI","zh-CN":"子 AI"},
    "graph.subagent_sessions": {"ko":"서브에이전트 세션","en":"Subagent sessions","zh-CN":"子智能体会话"},
    ...
    "graph.subagents_created": {"ko":"서브에이전트 {count}개 누적 생성","en":"{count} subagents created in total","zh-CN":"累计创建 {count} 个子智能体"},
    ...
    "graph.tmux_runtime_description": {"ko":"Linux 작업 묶음·창·분할 칸을 유지해서 실행 중인 AI","en":"AI running in persistent Linux workspaces, windows, and split panes","zh-CN":"在持续保持的 Linux 工作组、窗口和分割窗格中运行的 AI"},
    ...
    "graph.view_child_flow": {"ko":"{task}의 하위 서브에이전트 흐름 보기","en":"View child subagent flow for {task}","zh-CN":"查看{task}的下级子智能体流程"},
    "graph.view_child_subagents": {"ko":"하위 서브에이전트 {count}개 보기 →","en":"View {count} child subagents →","zh-CN":"查看 {count} 个下级子智能体 →"},
    ...
    "terminal.subagents.title": {"ko":"서브에이전트 작업 진행","en":"Subagent progress","zh-CN":"子智能体工作进度"},
    ...
    "terminal.tmux.confirm_end_workspace": {"ko":"{workspace} 작업 묶음을 모두 끝낼까요?","en":"End the entire {workspace} workspace?","zh-CN":"要结束整个 {workspace} 工作组吗？"},
    ...
    "terminal.tmux.prompt_workspace_name": {"ko":"새 작업 묶음 이름","en":"New workspace name","zh-CN":"新工作组名称"},
    "terminal.tmux.refreshed": {"ko":"여러 창 작업을 새로고침했습니다.","en":"Multi-terminal work refreshed.","zh-CN":"多终端工作已刷新。"},
    ...
    "terminal.tmux.workspace_count": {"ko":"작업 묶음 {count}개","en":"{count} workspaces","zh-CN":"{count} 个工作组"},
    "terminal.tmux.workspace_create_failed": {"ko":"새 tmux 작업을 만들지 못했습니다.","en":"Could not create the new tmux workspace.","zh-CN":"无法创建新的 tmux 工作组。"},
    "terminal.tmux.workspace_created": {"ko":"새 여러 창 작업을 만들었습니다.","en":"New multi-terminal workspace created.","zh-CN":"已创建新的多终端工作组。"},
    "terminal.tmux.workspace_ended": {"ko":"작업 묶음을 끝냈습니다.","en":"Workspace ended.","zh-CN":"工作组已结束。"},
    "terminal.tmux.workspace_renamed": {"ko":"작업 묶음 이름을 변경했습니다.","en":"Workspace renamed.","zh-CN":"工作组已重命名。"},
    ...
    "tmux.summary": {"ko":"{sessions}개 작업 묶음 · {panes}개 칸에서 AI가 일하는 중","en":"{sessions} workspaces · AI working in {panes} panes","zh-CN":"{sessions} 个工作组 · AI 正在 {panes} 个窗格中工作"},
    "tmux.view_conversation": {"ko":"대화 내용 보기 ↗","en":"View conversation ↗","zh-CN":"查看对话 ↗"},
    "tmux.workspace": {"ko":"작업 묶음","en":"Workspaces","zh-CN":"工作组"},
    ...
    "ui.add_workspace": {"ko":"프로젝트 고정","en":"Pin project","zh-CN":"固定项目"},
    ...
    "ui.workspaces": {"ko":"프로젝트","en":"Projects","zh-CN":"项目"},
    ...
    "management.action_required": {"ko":"조치 필요","en":"Action required","zh-CN":"需要处理"},
    "management.advanced_tools": {"ko":"고급 도구","en":"Advanced tools","zh-CN":"高级工具"},
    "management.approve": {"ko":"승인하고 계속","en":"Approve and continue","zh-CN":"批准并继续"},
    "management.artifacts": {"ko":"관측된 산출물","en":"Observed artifacts","zh-CN":"已观测产物"},
    ...
    "management.attention.none": {"ko":"조치 없음","en":"No action","zh-CN":"无需处理"},
    ...
    "management.check.failed": {"ko":"실패","en":"Failed","zh-CN":"失败"},
    "management.check.passed": {"ko":"통과","en":"Passed","zh-CN":"通过"},
    "management.check.running": {"ko":"실행 중","en":"Running","zh-CN":"运行中"},
    ...
    "management.control_retry_sent": {"ko":"동일한 설정으로 새 실행을 시작했습니다.","en":"A new run started with the same settings.","zh-CN":"已使用相同设置开始新任务。"},
    ...
    "management.deny": {"ko":"거절하고 중단","en":"Deny and stop","zh-CN":"拒绝并停止"},
    "management.detected": {"ko":"로그에서 감지","en":"Detected in logs","zh-CN":"从日志检测"},
    "management.evidence.high": {"ko":"높은 신뢰도","en":"High confidence","zh-CN":"高可信度"},
    "management.evidence.inferred": {"ko":"활동에서 추정","en":"Inferred from activity","zh-CN":"根据活动推断"},
    "management.evidence.low": {"ko":"낮은 신뢰도","en":"Low confidence","zh-CN":"低可信度"},
    "management.evidence.medium": {"ko":"보통 신뢰도","en":"Medium confidence","zh-CN":"中等可信度"},
    "management.evidence.observed": {"ko":"공식 이벤트로 관측","en":"Observed from an event","zh-CN":"由正式事件观测"},
    "management.evidence.unverified": {"ko":"완료 검증 안 됨","en":"Completion unverified","zh-CN":"完成情况未验证"},
    "management.evidence_completion": {"ko":"완료 근거","en":"Completion evidence","zh-CN":"完成依据"},
    "management.evidence_hierarchy": {"ko":"관계 근거","en":"Hierarchy evidence","zh-CN":"关系依据"},
    "management.evidence_status": {"ko":"상태 근거","en":"Status evidence","zh-CN":"状态依据"},
    "management.evidence_title": {"ko":"관측 근거와 신뢰도","en":"Evidence and confidence","zh-CN":"观测依据与可信度"},
    "management.health.attention": {"ko":"사용자 조치 대기","en":"Waiting for user action","zh-CN":"等待用户处理"},
    "management.health.critical": {"ko":"즉시 확인","en":"Critical","zh-CN":"需立即确认"},
    "management.health.healthy": {"ko":"정상","en":"Healthy","zh-CN":"正常"},
    "management.health.unknown": {"ko":"근거 부족","en":"Unknown","zh-CN":"依据不足"},
    "management.filter_all": {"ko":"전체 검토 대상","en":"All review items","zh-CN":"全部待检查项"},
    ...
    "management.health.warning": {"ko":"주의","en":"Warning","zh-CN":"警告"},
    "management.health_title": {"ko":"실행 건강 상태","en":"Run health","zh-CN":"执行健康状态"},
    "management.inbox_description": {"ko":"질문·승인·오류처럼 사람이 처리해야 다음 단계로 갈 수 있는 일을 모았습니다.","en":"Questions, approvals, and failures that need a person before work can continue.","zh-CN":"汇总需要人工处理后才能继续的问题、批准和错误。"},
    "management.inbox_empty": {"ko":"지금 처리할 일이 없습니다","en":"Nothing needs action now","zh-CN":"目前无需处理"},
    "management.inbox_empty_detail": {"ko":"새 질문이나 오류가 관측되면 이곳에 바로 나타납니다.","en":"New questions or failures will appear here immediately.","zh-CN":"出现新问题或错误时会立即显示在这里。"},
    "management.inbox_eyebrow": {"ko":"ACTION INBOX","en":"ACTION INBOX","zh-CN":"待处理收件箱"},
    "management.inbox_label": {"ko":"조치가 필요한 에이전트 작업","en":"Agent work needing action","zh-CN":"需要处理的智能体任务"},
    "management.inbox_title": {"ko":"내가 처리해야 계속되는 일","en":"Work waiting on me","zh-CN":"等待我处理的任务"},
    "management.last_signal": {"ko":"마지막 신호 {time}","en":"Last signal {time}","zh-CN":"最后信号 {time}"},
    "management.no_artifacts": {"ko":"파일·커밋·테스트 산출물이 아직 로그에서 관측되지 않았습니다.","en":"No file, commit, or test artifacts have been observed yet.","zh-CN":"日志中尚未观测到文件、提交或测试产物。"},
    "management.no_checks": {"ko":"검증 실행 기록이 아직 없습니다.","en":"No verification run has been observed yet.","zh-CN":"尚未观测到验证执行记录。"},
    "management.no_current_step": {"ko":"현재 단계 정보 없음","en":"Current step unavailable","zh-CN":"当前步骤不可用"},
    "management.no_health_signals": {"ko":"현재 감지된 위험 신호가 없습니다.","en":"No risk signals are currently detected.","zh-CN":"当前未检测到风险信号。"},
    "management.operations_clear": {"ko":"정체·실패·컨텍스트 위험 없이 정상적으로 관측되고 있습니다.","en":"No stalls, failures, or context risks are currently detected.","zh-CN":"当前未检测到停滞、失败或上下文风险。"},
    "management.operations_description": {"ko":"루트 작업과 서브에이전트의 위험 신호를 심각도순으로 정리했습니다.","en":"Risk signals from root tasks and subagents are ordered by severity.","zh-CN":"按严重程度汇总根任务与子智能体的风险信号。"},
    "management.operations_eyebrow": {"ko":"운영 상태","en":"OPERATIONS","zh-CN":"运行状态"},
    "management.operations_label": {"ko":"에이전트 운영 상태","en":"Agent operational health","zh-CN":"智能体运行状态"},
    "management.operations_review_count": {"ko":"검토 대상","en":"Need review","zh-CN":"待检查"},
    "management.operations_view_all": {"ko":"모두 보기","en":"View all","zh-CN":"查看全部"},
    "management.operations_severity_buckets": {"ko":"루트 작업과 서브에이전트를 포함한 실행 단위 수","en":"Execution units including root tasks and subagents","zh-CN":"包含根任务与子智能体的执行单元数"},
    "management.operations_title": {"ko":"확인이 필요한 신호","en":"Signals that need attention","zh-CN":"需要关注的信号"},
    ...
    "management.progress": {"ko":"구조화된 진행 상황","en":"Structured progress","zh-CN":"结构化进度"},
    "management.progress_steps": {"ko":"{completed}/{total} 단계 완료","en":"{completed}/{total} steps complete","zh-CN":"已完成 {completed}/{total} 步"},
    ...
    "management.reassign": {"ko":"다른 AI로 넘기기","en":"Reassign to another AI","zh-CN":"转交给其他 AI"},
    "management.reassign_prompt": {"ko":"{provider}에서 진행하던 다음 작업을 이어받아 현재 상태를 확인하고 완료해 주세요.\n\n원래 목표: {task}","en":"Take over the following work from {provider}, inspect its current state, and complete it.\n\nOriginal goal: {task}","zh-CN":"接手 {provider} 正在进行的以下任务，检查当前状态并完成。\n\n原始目标：{task}"},
    "management.reassign_unavailable": {"ko":"설치되어 있고 표시 중인 다른 AI가 없어 재배정할 수 없습니다.","en":"No other installed and visible AI is available for reassignment.","zh-CN":"没有其他已安装且可见的 AI 可用于转交。"},
    ...
    "management.retry": {"ko":"동일 설정으로 재시도","en":"Retry with same settings","zh-CN":"使用相同设置重试"},
    "management.review_detail": {"ko":"근거와 상세 보기","en":"Review evidence and details","zh-CN":"查看依据和详情"},
    "management.risk_total": {"ko":"주의·컨텍스트 위험","en":"Warnings and context risk","zh-CN":"警告与上下文风险"},
    "management.signal.context-critical": {"ko":"컨텍스트 사용량 90% 이상","en":"Context usage above 90%","zh-CN":"上下文使用率超过 90%"},
    "management.signal.context-warning": {"ko":"컨텍스트 사용량 75% 이상","en":"Context usage above 75%","zh-CN":"上下文使用率超过 75%"},
    "management.signal.low-confidence": {"ko":"상태 근거가 부족함","en":"Low-confidence status","zh-CN":"状态依据不足"},
    "management.signal.orphan-agent": {"ko":"부모 작업을 찾을 수 없는 에이전트","en":"Agent has no observable parent","zh-CN":"无法找到父任务的智能体"},
    ...
    "management.signal.stale": {"ko":"최근 활동이 지연됨","en":"Recent activity is delayed","zh-CN":"最近活动延迟"},
    "management.signal.stalled": {"ko":"작업 정체 감지","en":"Run appears stalled","zh-CN":"检测到任务停滞"},
    "management.signal.waiting-too-long": {"ko":"사용자 응답을 오래 기다림","en":"Waiting too long for user input","zh-CN":"等待用户输入时间过长"},
    "management.signal_unavailable": {"ko":"관측 시각 없음","en":"Signal time unavailable","zh-CN":"无观测时间"},
    ...
    "management.unverified": {"ko":"검증 필요","en":"Needs verification","zh-CN":"需要验证"},
    "management.verification_checks": {"ko":"테스트·검증 기록","en":"Test and verification records","zh-CN":"测试与验证记录"},
    "management.verified": {"ko":"완료 이벤트 확인","en":"Completion event verified","zh-CN":"已确认完成事件"},
